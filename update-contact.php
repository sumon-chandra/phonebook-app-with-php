...
try {
    ...
    $phone = isset($contact["phone_number"]) ? htmlspecialchars($contact["phone_number"]) : '';
            ...
            <form action="includes/contacts/update-contact-handler.php" method="post" enctype="multipart/form-data" class="md:w-3/4 mx-auto flex flex-col gap-3 p-6 rounded-sm mt-10 bg-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div class="flex flex-col col-span-1 md:col-span-2">
                        ...
                        <input type="date" id="dob" name="dob" value="<?= $dob ?>" required class="p-2 focus:outline-none border rounded">
                    </div>
                    <div class="flex flex-col col-span-1 md:col-span-2">
